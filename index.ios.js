...
import { fileReader, useGetTotal } from './parser.js'
...
function readFileAndUnzip(code, houseType, finishReadFun){
  ...
  const readfilepath = dirs.DocumentDir+"/RNFetchBlob_tmp/test3/" +code+ "_LVR_LAND_"+houseType+".CSV";
